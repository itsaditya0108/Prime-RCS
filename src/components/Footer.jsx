                ...
                <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-12 lg:gap-8 mb-16">
                    ...
                    <div className="lg:col-span-1">
                        <Link to="/" className="inline-flex items-center gap-3 mb-6 group">
                            <div className="relative">
                                ...
                                <img
                                    src={logo}
                                    alt="SureMsg"
                                    className="relative h-10 w-10 rounded-full object-cover border border-slate-700 bg-slate-800"
                                />
                            </div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="#" className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center hover:bg-[#E4405F] hover:text-white transition-all duration-300 text-slate-400">
